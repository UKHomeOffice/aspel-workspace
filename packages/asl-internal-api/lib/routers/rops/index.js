...
module.exports = () => {
  ...
  router.get('/:year/establishments', (req, res, next) => {
    ...
    // get a list of all projects for the establishment with outstanding rops - ropsDeadline is generated by a SELECT
    // in getRopsDeadline() so it cannot be used in a WHERE or a HAVING at this level
