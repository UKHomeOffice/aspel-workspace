...
describe('Billing queries model', () => {
  ...
  before(async () => {
    ...
    try {
      await this.models.Profile.query().insert([
        {
          id: ids.asru,
          firstName: 'Asru',
          lastName: 'Admin',
      ...
      await this.models.Establishment.query().insertGraph([
        {
          id: 100,
      ...
      await this.models.TrainingCourse.query().insertGraph([
        {
          establishmentId: 100,
      ...
      await this.models.FeeWaiver.query().insertGraph([
        {
          establishmentId: 100,
          profileId: ids.piles[3],
          year: 2020,
  ...
  describe('billable', () => {
    it('includes training pils in billing data', async () => {
      const result = await this.models.Profile.query().whereHasBillablePIL({ establishmentId: 100, start: '2020-04-06', end: '2021-04-05' });
    ...
    it('excludes waived PILs if `whereNotWaived` is applied', async () => {
      const result = await this.models.Profile.query()
