module.exports = {
  ...
  subject: {
    ...
    'project-intention-to-refuse': 'Important: Notice of intention to refuse a project licence',
    'project-refusal-deadline-passed': 'Important: Confirm if project licence application is refused',
    ...
    'training-due-reminder': 'Reminder: {{addressingUserDirectly || fullName}} needs to complete their {{type}} mandatory training',
