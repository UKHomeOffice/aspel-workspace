...
// jest.mock('@asl/projects/client/components/training-summary-renderer', () => ({
//   trainingSummaryRenderer: jest.fn()
// }));
describe('Deadline component', () => {
  ...
  test('displays passed deadline notice when internal deadline is yesterday', () => {
    MockDate.set('2023-09-09T08:00:00Z');
    const { container, getByText } = renderDeadline({ date: '2023-09-08' });

    expect(container.querySelector('h2')).toHaveTextContent('Process by: 8 September 2023');
    expect(getByText('Internal deadline')).toBeInTheDocument();
    expect(getByText('8 September 2023')).toBeInTheDocument();
    expect(getByText('(Deadline passed 1 day ago)')).toBeInTheDocument();
  });
});
