...
const parse = project => {
  return {
    ...
    raDate: project.ra_date ? formatIsoDate(project.ra_date) : '',
    ...
    expiry_date: formatIsoDate(project.expiry_date),
    revocation_date: project.revocation_date ? formatIsoDate(project.revocation_date) : '',
